...
$(document).ready(function () {
    ...
    function getWeather() {
        // create url
        let weatherURL = "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=" + searchedCity + "&APPID=" + apiKey;
        ...
        $.ajax({
            ...
            var uvURL = "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/uvi?&APPID=" + apiKey +"&lat=" + lat + "&lon=" + long;
